-- ============================================================
-- init-practice-db.sql
--
-- Creates and populates the 7 practice tables used for SQL exercises:
--   faculties, departments, professors, subjects,
--   students, exams, professor_subjects
--
-- Safe to run on an existing database — drops and recreates these
-- tables from scratch.  Does NOT touch user/progress tables:
...
INSERT INTO faculties (name, city, university_name) VALUES
...
-- ── departments (17 rows) ───────────────────────────────────────────────────
-- FON — faculty_id = 1
INSERT INTO departments (name, location, faculty_id) VALUES
...
INSERT INTO professors (first_name, last_name, title, email) VALUES
...
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Informacioni sistemi i tehnologije')           WHERE id IN (1, 7);
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Softversko inženjerstvo i računarska tehnika') WHERE id = 2;
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Telekomunikacije i obrada informacija')        WHERE id = 8;
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Matematika')                                   WHERE id IN (3, 9);
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Finansije i računovodstvo')                    WHERE id = 4;
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Marketing i menadžment')                      WHERE id = 10;
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Primenjena matematika')                        WHERE id = 5;
UPDATE professors SET department_id = (SELECT id FROM departments WHERE name = 'Mašinstvo i procesna tehnika')                 WHERE id = 6;


-- ── subjects (48 rows, ids 1–48) ────────────────────────────────────────────
INSERT INTO subjects (name, semester, ects, faculty_id) VALUES
...
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Informacioni sistemi i tehnologije')           WHERE id BETWEEN 1  AND 8;
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Softversko inženjerstvo i računarska tehnika') WHERE id IN (9, 14);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Elektronika')                                  WHERE id IN (10, 11, 12);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Telekomunikacije i obrada informacija')        WHERE id IN (13, 15, 16);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Matematika')                                   WHERE id IN (17, 18, 19, 20, 21, 22);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Informatika')                                  WHERE id IN (23, 24);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Opšta ekonomija')                              WHERE id IN (25, 26, 30);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Finansije i računovodstvo')                    WHERE id IN (27, 28, 32);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Marketing i menadžment')                      WHERE id IN (29, 31);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Primenjena matematika')                        WHERE id IN (33, 34, 35, 37, 39, 40);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Čista matematika')                            WHERE id IN (36, 38);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Mašinstvo i procesna tehnika')                 WHERE id IN (41, 42, 43, 44);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Mehatronika i robotika')                      WHERE id IN (45, 46);
UPDATE subjects SET department_id = (SELECT id FROM departments WHERE name = 'Industrijsko inženjerstvo')                    WHERE id IN (47, 48);


-- ── students (90 rows, ids 1–90) ────────────────────────────────────────────
-- FON (faculty_id = 1, ids 1–15)
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id) VALUES
...
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Informacioni sistemi i tehnologije') WHERE faculty_id = 1 AND id BETWEEN 1  AND 10;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Menadžment i organizacija')          WHERE faculty_id = 1 AND id BETWEEN 11 AND 15;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Softversko inženjerstvo i računarska tehnika') WHERE faculty_id = 2 AND id BETWEEN 16 AND 23;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Telekomunikacije i obrada informacija')        WHERE faculty_id = 2 AND id BETWEEN 24 AND 30;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Matematika')  WHERE faculty_id = 3 AND id BETWEEN 31 AND 38;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Informatika') WHERE faculty_id = 3 AND id BETWEEN 39 AND 45;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Finansije i računovodstvo') WHERE faculty_id = 4 AND id BETWEEN 46 AND 53;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Marketing i menadžment')    WHERE faculty_id = 4 AND id BETWEEN 54 AND 60;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Primenjena matematika') WHERE faculty_id = 5 AND id BETWEEN 61 AND 70;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Čista matematika')     WHERE faculty_id = 5 AND id BETWEEN 71 AND 75;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Mašinstvo i procesna tehnika') WHERE faculty_id = 6 AND id BETWEEN 76 AND 83;
UPDATE students SET department_id = (SELECT id FROM departments WHERE name = 'Mehatronika i robotika')       WHERE faculty_id = 6 AND id BETWEEN 84 AND 90;
...
INSERT INTO exams (student_id, subject_id, professor_id, exam_date, grade) VALUES
(1,  1,  1, '2023-06-15', 8),
(1,  2,  1, '2023-09-10', 7),
(2,  1,  1, '2023-06-15', 9),
(2,  3,  1, '2023-09-10', 5),
