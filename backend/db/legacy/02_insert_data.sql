-- ============================================================
-- 02_insert_data.sql — Test podaci
-- ============================================================
...
-- faculties
-- ============================================================
INSERT INTO faculties (name, city, university_name, department_id) VALUES
('Fakultet organizacionih nauka', 'Beograd',  'Univerzitet u Beogradu',   NULL),
('Elektrotehnički fakultet',       'Beograd',  'Univerzitet u Beogradu',   NULL),
('Prirodno-matematički fakultet',  'Novi Sad', 'Univerzitet u Novom Sadu', NULL),
('Ekonomski fakultet',             'Niš',      'Univerzitet u Nišu',       NULL),
('Matematički fakultet',           'Beograd',  'Univerzitet u Beogradu',   NULL),
('Fakultet tehničkih nauka',       'Novi Sad', 'Univerzitet u Novom Sadu', NULL);


-- ============================================================
-- subjects  (8 po fakultetu, ids 1–48)
-- ============================================================
INSERT INTO subjects (name, semester, ects, faculty_id) VALUES
-- FON  (faculty_id = 1)  →  subject ids 1–8
...
-- ETF  (faculty_id = 2)  →  subject ids 9–16
('Matematika 1',                      1, 8, 2),
('Fizika 1',                          1, 7, 2),
...
-- PMF NS  (faculty_id = 3)  →  subject ids 17–24
('Analiza 1',                         1, 8, 3),
...
-- EKF Niš  (faculty_id = 4)  →  subject ids 25–32
...
-- MAT Beograd  (faculty_id = 5)  →  subject ids 33–40
...
-- FTN NS  (faculty_id = 6)  →  subject ids 41–48
('Mehanika 1',                        1, 7, 6),
('Termodinamika',                     2, 6, 6),
...
-- ============================================================
-- students — FON  (faculty_id = 1, ids 1–15)
-- ============================================================
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id, department_id) VALUES
('Marko',    'Petrović',   'FON-22-001', 2022, 1, NULL),
('Ana',      'Nikolić',    'FON-22-002', 2022, 1, NULL),
('Stefan',   'Jovanović',  'FON-21-003', 2021, 1, NULL),
('Jelena',   'Milošević',  'FON-22-004', 2022, 1, NULL),
('Nikola',   'Đorđević',   'FON-23-005', 2023, 1, NULL),
('Milica',   'Stojanović', 'FON-22-006', 2022, 1, NULL),
('Aleksa',   'Popović',    'FON-21-007', 2021, 1, NULL),
('Ivana',    'Đukić',      'FON-22-008', 2022, 1, NULL),
('Petar',    'Lazić',      'FON-23-009', 2023, 1, NULL),
('Maja',     'Vasić',      'FON-22-010', 2022, 1, NULL),
('Milan',    'Marković',   'FON-21-011', 2021, 1, NULL),
('Tamara',   'Pavlović',   'FON-22-012', 2022, 1, NULL),
('Jovan',    'Simić',      'FON-23-013', 2023, 1, NULL),
('Marina',   'Ristić',     'FON-22-014', 2022, 1, NULL),
('Filip',    'Stanković',  'FON-21-015', 2021, 1, NULL);

-- students — ETF  (faculty_id = 2, ids 16–30)
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id, department_id) VALUES
('Lazar',    'Đurić',      'ETF-22-001', 2022, 2, NULL),
('Katarina', 'Ilić',       'ETF-22-002', 2022, 2, NULL),
('Nemanja',  'Tešić',      'ETF-21-003', 2021, 2, NULL),
('Bojana',   'Nešić',      'ETF-22-004', 2022, 2, NULL),
('Vuk',      'Matić',      'ETF-23-005', 2023, 2, NULL),
('Dragana',  'Đorić',      'ETF-22-006', 2022, 2, NULL),
('Bogdan',   'Nikolić',    'ETF-21-007', 2021, 2, NULL),
('Sandra',   'Petrović',   'ETF-22-008', 2022, 2, NULL),
('Uroš',     'Jovanović',  'ETF-23-009', 2023, 2, NULL),
('Nevena',   'Milić',      'ETF-22-010', 2022, 2, NULL),
('Mihajlo',  'Stefanović', 'ETF-21-011', 2021, 2, NULL),
('Tijana',   'Filipović',  'ETF-22-012', 2022, 2, NULL),
('Bojan',    'Đukić',      'ETF-23-013', 2023, 2, NULL),
('Vesna',    'Lazović',    'ETF-22-014', 2022, 2, NULL),
('Đorđe',    'Ristić',     'ETF-21-015', 2021, 2, NULL);

-- students — PMF NS  (faculty_id = 3, ids 31–45)
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id, department_id) VALUES
('Sara',      'Kovačević',  'PMF-22-001', 2022, 3, NULL),
('Dragan',    'Tomić',      'PMF-22-002', 2022, 3, NULL),
('Emilija',   'Stanić',     'PMF-21-003', 2021, 3, NULL),
('Aleksandar','Lukić',      'PMF-22-004', 2022, 3, NULL),
('Jelena',    'Pejović',    'PMF-23-005', 2023, 3, NULL),
('Marija',    'Radović',    'PMF-22-006', 2022, 3, NULL),
('Nikola',    'Kostić',     'PMF-21-007', 2021, 3, NULL),
('Nataša',    'Vuković',    'PMF-22-008', 2022, 3, NULL),
('Danilo',    'Čukić',      'PMF-23-009', 2023, 3, NULL),
('Milena',    'Aleksić',    'PMF-22-010', 2022, 3, NULL),
('Slobodan',  'Ninković',   'PMF-21-011', 2021, 3, NULL),
('Jovana',    'Ilić',       'PMF-22-012', 2022, 3, NULL),
('Rade',      'Đorđević',   'PMF-23-013', 2023, 3, NULL),
('Teodora',   'Miletić',    'PMF-22-014', 2022, 3, NULL),
('Nemanja',   'Bogdanović', 'PMF-21-015', 2021, 3, NULL);

-- students — EKF Niš  (faculty_id = 4, ids 46–60)
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id, department_id) VALUES
('Kristina',  'Stevanović', 'EKF-22-001', 2022, 4, NULL),
('Branko',    'Todorović',  'EKF-22-002', 2022, 4, NULL),
('Tatjana',   'Marinković', 'EKF-21-003', 2021, 4, NULL),
('Miloš',     'Đorđić',     'EKF-22-004', 2022, 4, NULL),
('Aleksandra','Milović',    'EKF-23-005', 2023, 4, NULL),
('Srđan',     'Stević',     'EKF-22-006', 2022, 4, NULL),
('Biljana',   'Đurić',      'EKF-21-007', 2021, 4, NULL),
('Dušan',     'Tomić',      'EKF-22-008', 2022, 4, NULL),
('Sonja',     'Radulović',  'EKF-23-009', 2023, 4, NULL),
('Nemanja',   'Jović',      'EKF-22-010', 2022, 4, NULL),
('Olivera',   'Stanković',  'EKF-21-011', 2021, 4, NULL),
('Miroslav',  'Savić',      'EKF-22-012', 2022, 4, NULL),
('Dragana',   'Milošević',  'EKF-23-013', 2023, 4, NULL),
('Nenad',     'Petrović',   'EKF-22-014', 2022, 4, NULL),
('Ivona',     'Nikolić',    'EKF-21-015', 2021, 4, NULL);

-- students — MAT Beograd  (faculty_id = 5, ids 61–75)
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id, department_id) VALUES
('Miljan',   'Živković',      'MAT-22-001', 2022, 5, NULL),
('Zorana',   'Đorđević',      'MAT-22-002', 2022, 5, NULL),
('Nikola',   'Filipović',     'MAT-21-003', 2021, 5, NULL),
('Ana',      'Stanković',     'MAT-22-004', 2022, 5, NULL),
('Jovan',    'Milosavljević', 'MAT-23-005', 2023, 5, NULL),
('Vesna',    'Ilić',          'MAT-22-006', 2022, 5, NULL),
('Stevan',   'Vujović',       'MAT-21-007', 2021, 5, NULL),
('Maja',     'Milošević',     'MAT-22-008', 2022, 5, NULL),
('Andrija',  'Stanić',        'MAT-23-009', 2023, 5, NULL),
('Bojana',   'Janković',      'MAT-22-010', 2022, 5, NULL),
('Predrag',  'Tomić',         'MAT-21-011', 2021, 5, NULL),
('Snežana',  'Bošković',      'MAT-22-012', 2022, 5, NULL),
('Goran',    'Đukić',         'MAT-23-013', 2023, 5, NULL),
('Anđela',   'Petrović',      'MAT-22-014', 2022, 5, NULL),
('Ognjen',   'Ristić',        'MAT-21-015', 2021, 5, NULL);

-- students — FTN NS  (faculty_id = 6, ids 76–90)
INSERT INTO students (first_name, last_name, index_number, enrollment_year, faculty_id, department_id) VALUES
('Vladimir', 'Tošić',       'FTN-22-001', 2022, 6, NULL),
('Sanja',    'Đorić',       'FTN-22-002', 2022, 6, NULL),
('Rade',     'Savić',       'FTN-21-003', 2021, 6, NULL),
('Jelena',   'Marinović',   'FTN-22-004', 2022, 6, NULL),
('Mihajlo',  'Petrović',    'FTN-23-005', 2023, 6, NULL),
('Tamara',   'Ristić',      'FTN-22-006', 2022, 6, NULL),
('Dragan',   'Ilić',        'FTN-21-007', 2021, 6, NULL),
('Milena',   'Đurić',       'FTN-22-008', 2022, 6, NULL),
('Bojan',    'Nikolić',     'FTN-23-009', 2023, 6, NULL),
('Ivana',    'Jović',       'FTN-22-010', 2022, 6, NULL),
('Stanislav','Kovač',       'FTN-21-011', 2021, 6, NULL),
('Nina',     'Stefanović',  'FTN-22-012', 2022, 6, NULL),
('Dušan',    'Vasić',       'FTN-23-013', 2023, 6, NULL),
('Iva',      'Đorđević',    'FTN-22-014', 2022, 6, NULL),
('Marko',    'Radović',     'FTN-21-015', 2021, 6, NULL);


-- ============================================================
-- exams  (passed je generated kolona — ne unositi je)
-- Raspored: student_id, subject_id, professor_id, exam_date, grade
-- ============================================================
